...
public class Venta {
    ...
    private List<DetalleVenta> detalles = new ArrayList<>(); // ✅ Inicializada para evitar null
    ...
    public Venta(int id, Usuario usuario, java.time.LocalDateTime fechaHora, double subtotal,
        ...
        this.total = total;
        this.detalles = detalles != null ? detalles : new ArrayList<>(); // ✅ Seguro
    }
    ...
    public Venta(Usuario usuario, java.time.LocalDateTime fechaHora, double subtotal,
        ...
        this(0, usuario, fechaHora, subtotal, impuestoIVA, impuestoIVI, descuento, 0, new ArrayList<>());
    }
    ...
    /**
     * Método útil para verificar si la venta tiene detalles.
     */
